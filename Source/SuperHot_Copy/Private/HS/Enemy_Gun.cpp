...
AEnemy_Gun::AEnemy_Gun()
{
	...
	if (GetMesh())
	{
		...
		// 총 메시 로드
		static ConstructorHelpers::FObjectFinder<UStaticMesh> FoundGunMesh(TEXT("/Script/Engine.StaticMesh'/Game/HS/assets/gun/gun.gun'"));
		if (FoundGunMesh.Succeeded())
		{
			GunMesh->SetStaticMesh(FoundGunMesh.Object);
		}
